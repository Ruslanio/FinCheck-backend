...
fun Application.configureTransactionRouting(transactionService: TransactionService) {
    routing {
        authenticate("auth-jwt") {
            route("/transactions") {
                get {
                    ...
                    try {
                        val result = transactionService.getTransactions(userId, page, size, category)
